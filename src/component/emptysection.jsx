          ...
          <Card className="h-64 bg-[#fafafa]">
            <CardContent className="flex items-center justify-center h-full">
              <div className="text-center">
                <div
                  className="h-12 w-12 border border-gray-200 flex items-center bg-white justify-center rounded-lg mx-auto mb-4"
                  aria-hidden="true"
                >
                  <ChartNoAxesCombined className="h-6 w-6 mx-auto" />
                </div>
                <h3 className="text-lg font-semibold mb-2">{section.title || 'Create an agent'}</h3>
                <p className="text-muted-foreground mb-4">{section.description}</p>
                {!section.title && (
                  <Button
                    className="rounded-xl"
                    aria-label={section.buttonText || 'Create an agent'}
                  >
