...
const Conversationalmain = () => {
  ...
  return (
    <div className={`${inter.variable} pt-20 mx-auto overflow-auto max-w-[1080px] w-full`}>
      <div className="flex items-center justify-between p-4 bg-white">
        <div className="flex items-center gap-2 border border-gray-200 py-2 px-4 rounded-full">
          <div className="w-2 h-2 bg-black rounded-full"></div>
          <span className="text-sm text-semibold">Active calls: <span className="font-bold">0</span></span>
        </div>
        <DialogDemo />
      </div>
          ...
          <div className="flex items-center gap-4 mb-6">
            <Select defaultValue="all-agents">
              ...
              <SelectContent className="min-w-72 w-full" >
                <Input type="text" placeholder="Search..." className="w-full mb-2" />
